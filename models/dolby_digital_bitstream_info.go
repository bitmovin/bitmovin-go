...
type DolbyDigitalBitstreamInfo struct {
	...
	SurroundMode bitmovintypes.DolbyDigitalSurroundMode `json:"surroundMode,omitempty"`
	...
	SurroundExMode bitmovintypes.DolbyDigitalSurroundMode `json:"surroundExMode,omitempty"`
}
